...
const pagesRoutes = [
  { path: "/cpdev/pages/user-list-1", element: <UserList1 /> },
  { path: "/cpdev/pages/user-list-2", element: <UserList2 /> },
  { path: "/cpdev/pages/user-list-3", element: <UserList3 /> },
  { path: "/cpdev/pages/user-list-4", element: <UserList4 /> },
  { path: "/cpdev/pages/faq-1", element: <Faq1 /> },
  { path: "/cpdev/pages/faq-2", element: <Faq2 /> },
  { path: "/cpdev/pages/customer-list", element: <CustomerList /> },
  { path: "/cpdev/pages/new-customer", element: <CustomerForm /> },
  { path: "/cpdev/pages/view-customer", element: <CustomerViewer /> },
  { path: "/cpdev/pages/product-list", element: <ProductList /> },
  { path: "/cpdev/pages/new-product", element: <ProductForm /> },
  { path: "/cpdev/pages/view-product", element: <ProductViewer /> },
  { path: "/cpdev/pages/order-list", element: <OrderList /> },
];
