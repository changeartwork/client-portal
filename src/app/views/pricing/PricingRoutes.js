...
const pricingRoutes = [
  { path: "/cpdev/others/pricing-1", element: <Pricing1 /> },
  { path: "/cpdev/others/pricing-2", element: <Pricing2 /> },
  { path: "/cpdev/others/pricing-3", element: <Pricing3 /> },
  { path: "/cpdev/others/pricing-4", element: <Pricing4 /> },
];
